      ...
      <div className="relative overflow-hidden group h-56">
        ...
        <div className="absolute top-4 right-4 z-20">
          <div className="relative">
            <div className="absolute -top-2 -right-2 w-24 h-24 rounded-full bg-red-500/10" />
            <div className="relative bg-red-600 text-white px-4 py-2 rounded-full flex items-center gap-2">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-center mt-auto">
          ...
          >
            <Link
              to={`/product/${id}`}
              className="bg-gradient-to-r from-purple-600 to-purple-700 text-white px-4 py-2 rounded-md hover:from-purple-700 hover:to-purple-800 transition-all duration-300 shadow-md"
            >
              Buy Now
            </Link>
          </motion.div>
